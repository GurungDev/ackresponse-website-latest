...
export default function ServiceSolutions({ slides, title }: Props) {
  ...
  useEffect(() => {
    setLoop(slides.length > 6);
  }, [slides.length]);

  
  return (
    <section id="solutions" className="pt-10 md:pt-14 bg-[#000] text-white ">
...
>
          ...
          {slides.map((data, i) => (
            <SwiperSlide key={i} className="z-[49]">
              <div className="!flex !flex-col group !items-center !justify-center w-full h-[35vh]  md:min-h-[35vh] portrait:lg:min-h-[35vh] relative lg:min-h-[50vh] rounded-xl overflow-hidden "
              ...
              >
                ...
                <Image
                  ...
                  width={400}
                  height={400}
                  className="object-cover w-full h-full absolute group-hover:scale-110 duration-300 group-hover:brightness-[60%] "
                />
