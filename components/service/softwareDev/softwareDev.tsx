...
const data = [
    ...
    },
    {
      ...
      image: "/insightpage/softwarePage/maintenance.jpg",
    },
    {
      id: "7",
      title: "01: REQUIREMENTS GATHERING",
    ...
    ' >
        ...
        lg:h-[500px] '>
            ...
            <div className='flex flex-col space-y-3 md:space-y-0'>
                ...
                <p className='lg:text-lg lg:w-[80%]'>From requirements gathering to design, development, testing, and ongoing support, we deliver seamless bespoke software development solutions tailored to your business needs every step of the way.</p>
            </div>
            ...
            <div className='lg:pt-16 '>
                ...
                '>
                    <p>Software To Us</p><p className='group-hover:translate-x-4 transition-all duration-300 delay-200 ease-in-out'><FaArrowRight/></p> 
                </button>
            </div>
            </Link>
            ...
            <SwiperSlide key={slide.id} className=" lg:space-y-4 bg-white rounded-lg shadowforslider ">
                ...
                ">
                  <div className='
                    ...
                    lg:h-64 w-full
                  '>
                  <Image priority={true} className='rounded-full flex justify-center items-center
                    object-center
                    h-44 w-44 
                    md:h-44 md:w-44 
                    lg:h-52 lg:w-52
...
export default SoftwareDevToUs