    ...
    ' >
        ...
        lg:h-[500px] '>
            ...
            <div className='flex flex-col space-y-3 md:space-y-0'>
                ...
                <p className='lg:text-lg lg:w-[80%]'>From requirements gathering to design, development, testing, and ongoing support, we deliver seamless web development solutions tailored to your business needs every step of the way.</p>
            </div>
            ...
            <div className='lg:pt-16 '>
                ...
                '>
                    <p>Web To Us</p><p className='group-hover:translate-x-4 transition-all duration-300 delay-200 ease-in-out'><FaArrowRight/></p> 
                </button>
            </div>
